  ...
  const computedMatches = React.useMemo(() => {
    return matches.reduce((result, match) => {
      if (match.stage === "FINALS_4_1") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_1") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_3") as UIMatch),
        }];
      }
      if (match.stage === "FINALS_4_2") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_2") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_4") as UIMatch),
        }];
      }
      if (match.stage === "FINALS_4_3") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_5") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_7") as UIMatch),
        }];
      }
      if (match.stage === "FINALS_4_4") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_6") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_8_8") as UIMatch),
        }];
      }
      if (match.stage === "FINALS_2_1") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_4_1") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_4_3") as UIMatch),
        }];
      }
      if (match.stage === "FINALS_2_2") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_4_2") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_4_4") as UIMatch),
        }];
      }
      if (match.stage === "FINALS") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_2_1") as UIMatch),
          countryRightId: getAdminFinalsMatchWinner(result.find((row) => row.stage === "FINALS_2_2") as UIMatch),
        }];
      }
      if (match.stage === "THIRD_PLACE") {
        return [...result, { ...match,
          countryLeftId: getAdminFinalsMatchLooser(result.find((row) => row.stage === "FINALS_2_1") as UIMatch),
          countryRightId: getAdminFinalsMatchLooser(result.find((row) => row.stage === "FINALS_2_2") as UIMatch),
        }];
      }
      return [...result, match];
    }, [] as UIMatch[]);
